...
+function(options) {
    ...
    }), $(".box__button-delivery").click(function() {
        var data = {
            user: login,
            item_1_id: null,
            item_2_id: null,
...
//            $(this).addClass("button-line__button_disabled").attr("disabled", "disabled").html("Идет открытие коробки..."),
    ...
    }), $("#payment-form").length && $("#payment-form").submit(), $(".shop-buy").click(function() {
...
$(document).ready(function(){
    ...
    socket.on('live', function (data1) {
        ...
        $.each(data1, function(i) {
            ...
            app.addFeedItem(data.image, data.avatar, '/account/'+data.user, light);
        });
    });
