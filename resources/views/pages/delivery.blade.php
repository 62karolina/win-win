        ...
        <div class="container">
            <div class="row dark-card">
                ...
                <div class="license_block-xs-12 license_block-sm-12 license_block-md-6 license_block-lg-7 ">
                    <div class="faq-block">
                        <div class="help-padge__faq-block-header faq-block__header text-block text-block_fs_m text-block_tf_up text-block_color_black">Доставка</div>
                        <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Как заказать товар, полученный из коробок?</div>
                        ...
                        <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Как отслеживать статус моей посылки?</div>
                        ...
                        <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Сколько стоит доставка?</div>
                        <div class="faq-block__answer text-block">Стоимость доставки для всех стран и регионов составляет 300 рублей. Оплата доставки списывается с баланса на сайте.</div>
                        <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Сколько товаров можно заказать одновременно?</div>
                        ...
                        <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Куда вы сможете доставить товары?</div>
                        <div class="faq-block__answer text-block">Доставка производится во все города России, Украины, Республики Беларусь, Казахстана, Азербайджана, Армении, Киргизии, Молдавии, Таджикистана, Туркмении и Узбекистана. Стоимость доставки не зависит от региона и составляет 300 рублей.</div>
                        <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Есть ли самовывоз?</div>
                        ...
                        <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Как быстро производится доставка?</div>
                        ...
                        <div class="help-padge__faq-block-header faq-block__header text-block text-block_fs_m text-block_tf_up text-block_color_black">Оплата</div>
                        <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Как пополнить баланс?</div>
                        ...
                        <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Минимальная и максимальная сумма пополнения баланса?</div>
                        ...
                        <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Как быстро зачисляются средства?</div>
                        ...
                        <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Можно выводить деньги?</div>
