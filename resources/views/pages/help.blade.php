            ...
            <div class="container">
                <div class="row dark-card">
                    ...
                    <div class="license_block-xs-12 license_block-sm-12 license_block-md-6 license_block-lg-7">
                        <div class="faq-block">
                            <div class="help-padge__faq-block-header faq-block__header text-block text-block_fs_m text-block_tf_up text-block_color_black">Часто задаваемые вопросы</div>
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Куда нужно ввести промокод?</div>
                            ...
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Можно ввести несколько промокодов?</div>
                            <div class="faq-block__answer text-block">Нет. Можно ввести и активировать только 1 промокод.</div>
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Что дает промокод?</div>
                            ...
                            <div class="help-padge__faq-block-header faq-block__header text-block text-block_fs_m text-block_tf_up text-block_color_black">Открытие коробок</div>
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Как это работает?</div>
                            ...
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Мне точно выпадет какой-то товар?</div>
                            ...
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Как открыть коробку и получить товар?</div>
                            ...
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Каким образом выпадает товар?</div>
                            ...
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Можно вернуть ненужный товар и еще раз открыть коробку?</div>
                            ...
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_black">Как заказать доставку товаров?</div>
