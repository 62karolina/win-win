                ...
                <div class="row dark-card">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-7">
                        <div class="faq-block">
                            ...
                            <div class="faq-block__answer text-block">Подробную информацию об условиях и порядке получения товаров вы можете прочитать в на странице «<a href="http://ranbox.ru.net/delivery">Доставка и оплата</a>».
                            </div>
                        </div>
                    </div>
                </div>
