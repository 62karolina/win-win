                    ...
                    <div class="box box_gray-box">
                        <div class="row">
                            <div class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                <div class="box__header-wrapper">
                                    <div class="box__header-line">
                                        ...
                                        <div class="box__cost">{{$case1->price}}<span class="rouble">p</span></div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-8 col-lg-8 hidden-xs hidden-sm">
                                <div class="box__item_header">Коробка содержит {{$c1}} товаров:</div>
                                @foreach($item1 as $item)
                                    <div class="box__item box__item_gray" >
                                        <div class="box__item-glow"></div>
                                        <img src="{{$item->image}}" class="box__item-img" style=" width: 70px;height: 70px;"/>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                ...
                <a href="/box/2">
                    <div class="box box_green-box">
                        <div class="row">
                            <div class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                <div class="box__header-wrapper">
                                    <div class="box__header-line">
                                        ...
                                        <div class="box__cost">{{$case2->price}}<span class="rouble">p</span></div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-8 col-lg-8 hidden-xs hidden-sm">
                                <div class="box__item_header">Коробка содержит {{$c2}} товаров:</div>
                ...
                <a href="/box/3">
                    <div class="box box_red-box">
                        <div class="row">
                            <div class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
                                ...
                                <div class="box__header-wrapper">
                                    <div class="box__header-line">
                                        ...
                                        <div class="box__cost">{{$case3->price}}<span class="rouble">p</span></div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-8 col-lg-8 hidden-xs hidden-sm">
                                <div class="box__item_header">Коробка содержит {{$c3}} товаров:</div>
