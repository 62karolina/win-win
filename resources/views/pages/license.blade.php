                    ...
                    <div class="license_block-xs-12 license_block-sm-12 license_block-md-6 license_block-lg-7 ">
                        <div class="faq-block">
                            <div class="faq-block__answer text-block">
                                ...
                                правообладателем сетевого ресурса https://bww.by и его посетителем (потребителем). При использовании данного сетевого ресурса предполагается,
                            ...
                            <div class="faq-block__question text-block-black text-block_fs_m text-block_color_black">
                                1. Данное Соглашение предусматривает формализацию процесса использования посетителем (потребителем) всех возможностей сетевого ресурса https://bww.by.
                           ...
                           <!-- <div class="faq-block__answer text-block">1.5. техническая поддержка, реализованная в виде онлайн-консультанта.</div> -->
                            ...
                            <div class="faq-block__question text-block-black text-block_fs_m text-block_color_black">
                                ...
                                размещенному на главной странице сетевого ресурса https://bww.by, а также услуг по доставке (в том числе продаже) имеющихся у посетителя (потребителя) таких продуктов.
                            </div>
                            <div class="faq-block__question text-block-black text-block_fs_m text-block_color_black">
                            ...
                            <div class="faq-block__question text-block-black text-block_fs_m text-block_color_black">
                                ...
                                которую осуществляет в автоматическом режиме специальный программный код, интегрированный в структуру сетевого ресурса https://bww.by,
                            ...
                            <div class="faq-block__question text-block-black text-block_fs_m text-block_color_black">
                                6. Важно! Если договор Купли-Продажи не был заключен, можно оформить возврат средств (внесенную сумму без бонусов).
                                В этом случае нужно написать письмо на Email: <u>support-bww@tut.by</u>
                                </div>
                            <div class="faq-block__question text-block-black text-block_fs_m text-block_color_black">
                                7. При использовании приобретённого товара гарантируется его работоспособность и соответствие
                            ...
                            <div class="faq-block__question text-block-black text-block_fs_m text-block_color_black">
                                8. Ознакомление со всей информацией, размещённой на страницах сетевого ресурса https://bww.by, является обязательным этапом перед
                                акцептованием данного Соглашения.
                            </div>
                            <div class="faq-block__question text-block-black text-block_fs_m text-block_color_black">
                                9. В случае внесения изменений в Соглашение, такие изменения вступают в силу с момента опубликования новой редакции Соглашения на Сайте,
                                если иной срок вступления изменений в силу не определен дополнительно при их публикации.
                            </div>
                            <div class="faq-block__question text-block-black text-block_fs_m text-block_color_black">
                                10. Настоящее Соглашение вводится на неопределенный срок и утрачивает свою силу при его аннулировании Администрацией Сайта.
                            </div>
                            <div class="faq-block__question text-block-black text-block_fs_m text-block_color_black">
                                11. Отмена совершённого акцепта (одобрения и безоговорочного согласия со всеми условиями) допускается только в случае технического сбоя,
                            ...
                            <div class="faq-block__question text-block-black text-block_fs_m text-block_color_black">
                                12. При возникновении споров и спорных ситуаций стороны обязуются разрешить возникший вопрос во внесудебном порядке.
                                Обо всех случаях незаконного использования личных данных, чужих электронных средств оплаты и других нарушениях посетитель
                                (потребитель) должен незамедлительно сообщить в службу поддержки сетевого ресурса https://bww.by на электронную почту wwbox@tut.by.
                                Срок для ответа на предъявленную претензию составляет 10 (десять) рабочих дней с момента ее получения.
                            </div>
                            <div class="faq-block__question text-block-black text-block_fs_m text-block_color_black">
                                13. В случае невозможности урегулировать спор во внесудебном порядке или при совершении правонарушения с использованием личных данных все
                                дальнейшие взаимоотношения могут быть переданы в суд для разбирательства по существу.
                                14. Товары могут отличаться от внешнего вида, представленных на фото, но будут идентичны по характеристикам.
                            </div>
                        </div>
                    </div>
                </div>
