    ...
    <div class="container">
        <div class="row dark-card">
            <div class="dark-card register">
                <div class="register__header text-block-black text-block_align_center text-block_fs_b text-block_tf_up">Анкета для регистрации: </div>
                <div class="row">
                    @if($user->userExist)
                        <div class="text-block-black text-block_tf_up register__input-header">Такой пользователь уже есть!!!</div>
                    @endif
                    ...
                    <form method="post" action="/register" class="form-horizontal">
                        ...
                        <div style="margin-left: 25%;" class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="text-block-black text-block_tf_up register__input-header">Фамилия Имя Отчество</div>
                            ...
                            <div class="text--black-black text-block_tf_up register__input-header">Логин</div>
                            <div class="input-block">
                            ...
                            <div class="text-block-black text-block_tf_up register__input-header">Email</div>
                            <div class="input-block">
