                    ...
                    <?php else: ?>
                        <div class="user-block">
                            <div class="user-block__ava-wrapper user-block__ava-wrapper_gray-border hidden-md">
                                <div class="circle-ava"><a href="/profile"><img src="<?php echo e(Auth::user()->avatar); ?>" alt="ava" class="circle-ava__img"></a></div>
                            </div>
                            <div class="user-block__info-wrapper hidden-xs"><a href="/profile" class="user-block__name">Мой профиль</a>
                                <div class="user-block__balance"><img src="/build/img/money__icon_yellow.png" alt="money" class="user-block__icon"><span><span class="user-balance"><?php echo e(Auth::user()->money); ?></span><span class="rouble">p</span></span></div>
