        ...
        <div class="help-padge">
            <div class="container">
                <div class="row dark-card">
                    <div class="col-xs-12">
                        <div class="help-padge__header text-block text-block_align_center text-block_fs_b text-block_tf_up text-block_fw_bold">Вопросы и ответы</div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-7">
                        <div class="faq-block">
                            <div class="help-padge__faq-block-header faq-block__header text-block text-block_fs_m text-block_tf_up text-block_fw_bold">Часто задаваемые вопросы</div>
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_yellow">Куда нужно ввести промокод?</div>
                            ...
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_yellow">Можно ввести несколько промокодов?</div>
                            <div class="faq-block__answer text-block">Нет. Можно ввести и активировать только 1 промокод.</div>
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_yellow">Что дает промокод?</div>
                            ...
                            <div class="help-padge__faq-block-header faq-block__header text-block text-block_fs_m text-block_tf_up text-block_fw_bold">Открытие коробок</div>
                            ...
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_yellow">Мне точно выпадет какой-то товар?</div>
                            <div class="faq-block__answer text-block">Открывая коробку мы гарантируем, что вы точно получите один из двенадцати товаров. Открытие коробки в RanBox аналогично киндер-сюрпризу, вы всегда получаете свой сюрприз.</div>
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_yellow">Как открыть коробку и получить товар?</div>
                            ...
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_yellow">Каким образом выпадает товар?</div>
                            ...
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_yellow">Можно вернуть ненужный товар и еще раз открыть коробку?</div>
                            ...
                            <div class="faq-block__question text-block text-block_fs_m text-block_fw_bold text-block_color_yellow">Как заказать доставку товаров?</div>
                            <div class="faq-block__answer text-block">Подробную информацию об условиях и порядке получения товаров вы можете прочитать в на странице «<a href="https://ranbox.ru.net/delivery">Доставка и оплата</a>».
                            </div>
                        </div>
                    </div>
                </div>
